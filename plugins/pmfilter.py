        ...
        if total_results == 0:
            ...
            return await message.reply_text(
                ...
                reply_markup=InlineKeyboardMarkup(
                        [[
                            InlineKeyboardButton('• ᴊᴏɪɴ ᴏᴜʀ ᴍᴏᴠɪᴇ ɢʀᴏᴜᴘ •', url ='https://telegram.me/XeonFlixGroup')
                        ]]
                    )
                )
...
async def pm_text(bot, message):
    ...
    await message.reply_text(
         ...
         reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("• ᴊᴏɪɴ ᴏᴜʀ ᴍᴏᴠɪᴇ ɢʀᴏᴜᴘ • ​ ", url=f"https://telegram.me/XeonFlixGroup")]]), disable_web_page_preview=True
    )
...
async def next_page(bot, query):
    ...
    if settings['button']:
        ...
        btn.insert(0, [
            InlineKeyboardButton("uᴘᴅᴀᴛᴇs", url=f"https://t.me/XeonBots"),
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    # don't change anything without contacting me @cryxelys
        ...
        buttons = [[
            InlineKeyboardButton('⚙️ ᴀᴅᴍɪɴ ᴏɴʟʏ 🔧', callback_data='extra'),
        ], [
            ...
            InlineKeyboardButton('ᴛᴇʟᴇɢʀᴀᴘ', callback_data='tele')     
        ], [
            ...
            InlineKeyboardButton('ᴇᴀʀɴ ᴍᴏɴᴇʏ', callback_data='shortner')        
        ], [
            ...
            InlineKeyboardButton('ᴀᴜᴅɪᴏ-ʙᴏᴏᴋ', callback_data='audiobook'),
            InlineKeyboardButton('ɪᴍᴀɢᴇ ᴘᴅғ', callback_data='imgpdf'),
            ...
            InlineKeyboardButton('ʏᴛᴛᴀɢ', callback_data='yttags'),
            ...
            InlineKeyboardButton('ᴄᴄ ᴛᴏᴏʟ', callback_data='cc'),
            InlineKeyboardButton('ᴇɴᴄʀʏᴘᴛ', callback_data='encrypt')            
        ], [
        ...
        buttons = [[
            InlineKeyboardButton('☎️ ᴄᴏɴᴛᴀᴄᴛ ᴏᴡɴᴇʀ ᴛᴏ ᴋɴᴏᴡ ᴍᴏʀᴇ', user_id=int(821215952))
        ],[
        ...
        buttons = [[
            InlineKeyboardButton('ʙᴀᴄᴋ', callback_data='help'),
            InlineKeyboardButton('ᴏᴡɴᴇʀ', url="t.me/MrXeonTG")
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await client.edit_message_media(
            query.message.chat.id, 
